"""Check that `query`ing an `NEODatabase`
...
class TestQuery(unittest.TestCase):
    ...
    def test_query_approaches_on_march_2_with_min_distance(self):
        ...
        # def test_query_approaches_in_march_
        # with_min_distance_and_max_distance(self):

    def test_query_approaches_minmax_distance(self):
        start_date = datetime.date(2020, 3, 1)
        end_date = datetime.date(2020, 3, 31)
        distance_max = 0.4
        distance_min = 0.1
        ...
        self.assertEqual(expected, received,
                         msg="Computed results do not match expected results.")
    # test_query_approaches_in_march_
    # with_distance_bounds_and_max_velocity

    def test_query_approaches_velocity(self):
        start_date = datetime.date(2020, 3, 1)
        end_date = datetime.date(2020, 3, 31)
        distance_max = 0.4
        distance_min = 0.1
    ...
    def test_query_approaches_in_spring_max_diameter(self):
        start_date = datetime.date(2020, 3, 1)
    ...
    def test_query_approaches_diameter_bounds(self):
        start_date = datetime.date(2020, 3, 1)
        end_date = datetime.date(2020, 5, 31)
        distance_max = 0.5
        distance_min = 0.05
        ...
        self.assertEqual(expected, received,
                         msg="Computed results do not match expected results.")
    # test_query_approaches_in_spring_with_all_
    # bounds_and_potentially_hazardous_neos(self):

    def test_query_approaches_hazardous_neos(self):
        start_date = datetime.date(2020, 3, 1)
        end_date = datetime.date(2020, 5, 31)
        distance_max = 0.5
        distance_min = 0.05
        ...
        # def test_query_approaches_in_spring_with_
        # all_bounds_and_not_potentially_
        # hazardous_neos(self):

    def test_query_approaches(self):
        start_date = datetime.date(2020, 3, 1)
        end_date = datetime.date(2020, 5, 31)
        distance_max = 0.5
        distance_min = 0.05
