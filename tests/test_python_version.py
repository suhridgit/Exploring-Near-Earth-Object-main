...
These tests should (successfully) fail,
but not crash, when invoked with Python 2:
...
class TestPythonVersion(unittest.TestCase):
    ...
    Make sure that you have a compatible
    version of Python and that you're using
    `python3` at the command-line
    (or that your environment resolves `python` to
